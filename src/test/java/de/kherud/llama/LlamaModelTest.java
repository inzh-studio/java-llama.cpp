...
public class LlamaModelTest {
    ...
    public static void setup() {
        ...
        modelParameters.setNGpuLayers(43).setEmbedding(true);

        if (modelPath == null) {
            modelParameters.setModelFilePath("models/codellama-7b.Q2_K.gguf");
            //modelParameters.setModelUrl("https://huggingface.co/TheBloke/CodeLlama-7B-GGUF/resolve/main/codellama-7b.Q2_K.gguf");               
        } else {
            modelParameters.setModelFilePath(modelPath);
        }
